            ...
            <div className='homepage-container' id='top'>
                ...
                <div className='compare-container'>
                    ...
                    <div className='comparisons'>
                        <div className='compare'>
                            <img src="/images/earthSearch.png" alt="" />
                            <h4>Search</h4>
                            <p>Find your dream home in the perfect area near your university.</p>
                        </div>
                        <div className='compare'>
                            <img src="/images/tickCross.png" alt="" />
                            <h4>Compare</h4>
                ...
                <div className='benefits-container'>
                    <div className='section-container'>
                        ...
                        <img className='section-image' src="/images/hand.png" alt="hand icon" />
                    </div>
                    <div className='section-container'>
                        <h3>Your favorite</h3>
                        <p>Shortlist your favourite properties and send enquiries in one click.</p>
                        <img className='section-image' src="/images/heart.png" alt="hand icon" />
                    </div>
                    <a href='#top'>Search & Compare</a>
                    <img className='man-image' src="/images/man.png" alt="student on phone" />
                </div>
            </div>
        </>
    )
